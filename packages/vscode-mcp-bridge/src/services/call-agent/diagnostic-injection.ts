...
import type {DiagnosticInjectionParams} from './agent-types.js';
import { DIAGNOSTIC_COLLECTION_NAME  } from './agent-types.js';
 ...
 */
export async function injectPromptDiagnosticWithCallback(params: DiagnosticInjectionParams): Promise<void> {
  ...
  try {
    ...
    // 4. Execute the callback command
