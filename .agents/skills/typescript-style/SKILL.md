...
description: TypeScript code style and optimization conventions for this repo — type-inference vs explicit typing, async/await over callbacks, descriptive naming, JSDoc accuracy, prefer interface over type for object shapes, Promise.all for safe parallelism. Use whenever editing or reviewing any `.ts` / `.tsx` file in this project, especially before writing new code or refactoring existing TypeScript.
---
